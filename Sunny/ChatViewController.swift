...
class ChatViewController: MessagesViewController{
        ...
        DispatchQueue.global().async {
                ...
                DispatchQueue.main.async {
                    ...
                    for data in snapshot.children {
                        ...
                        self.messageList = self.getMessages(user: user as [String : Any])
                    }
    ...
    func createMessage(data: [String : Any]) -> MockMessage {
        ...
        return MockMessage(attributedText: attributedText, sender: sender(id: data["senderId"] as! String,displayName: data["name"] as! String), messageId: data["key"] as! String, date: Date())
    }
...
extension ChatViewController: MessagesDataSource{
    ...
    func sender(id: String, displayName: String) -> Sender {
